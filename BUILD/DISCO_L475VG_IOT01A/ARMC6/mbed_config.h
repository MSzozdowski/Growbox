...
#define MBED_CONF_NSAPI_DEFAULT_WIFI_PASSWORD                                 "polibuda"                                                                                       // set by application[DISCO_L475VG_IOT01A]
#define MBED_CONF_NSAPI_DEFAULT_WIFI_SECURITY                                 WPA_WPA2                                                                                         // set by application[DISCO_L475VG_IOT01A]
#define MBED_CONF_NSAPI_DEFAULT_WIFI_SSID                                     "TelefonMI"                                                                                      // set by application[DISCO_L475VG_IOT01A]
